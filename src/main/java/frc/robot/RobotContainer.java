...
//mport frc.robot.commands.SpinIntakeRoller;
...
public class RobotContainer {
  ...
  //Subsystems
 // private final DiffDriveCommand drive;
 ...
 // private final Vision vision;
  ...
  //Commands
 // private final DiffDriveCommand defaultdrive;
  ...
  public RobotContainer() {
   ...
   // drive = DiffDriveCommand.getInstance();
