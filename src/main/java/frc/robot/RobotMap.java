...
public class RobotMap {
  ...
  public static final double ElevatorUpSpeed = 0.52;
  public static final double ElevatorUpPidDelta = 0.5; // match sign of up speed
  public static final double ElevatorDownSpeed = -0.45;
  ...
  public static final double IntakeIngressSpeed = 0.56;//channged to negative because of motor's polarity
  public static final double IntakeEgressSpeed = -0.70;//wtf is this name?
